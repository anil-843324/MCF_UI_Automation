...
public class TestConfig{
	...
	public static String from = "anilkumarsingh142200@gmail.com";
	public static String password = "Selenium@123";
	public static String[] to ={"hello@gmail.com","automationanil@gmail.com"};
	public static String subject = "Test Report";
	
	public static String messageBody ="TestMessage";
	public static String attachmentPath="C:\\Users\\amplificapital\\Desktop\\Desktop\\newyear.png";
